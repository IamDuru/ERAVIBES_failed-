...
from ERAVIBES.utils.database import get_assistant, is_active_chat
...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    ...
    font = ImageFont.truetype('ERAVIBES/assets/font.ttf', size=70)
    welcome_font = ImageFont.truetype('ERAVIBES/assets/font.ttf', size=61)
