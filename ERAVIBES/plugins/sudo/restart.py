...
@app.on_message(filters.command(["getlog", "logs", "getlogs", "ogs", "og"], prefixes=["/", "!", "%", ",", "", ".", "@", "#", "l", "L"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["update", "gitpull", "pdate", "itpull"], prefixes=["/", "!", "%", ",", "", ".", "@", "#", "u", "U", "G", "g"]) & SUDOERS)
@language
