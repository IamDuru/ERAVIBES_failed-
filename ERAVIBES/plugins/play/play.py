...
@app.on_message(
   filters.command(["play", "vplay", "cplay", "cvplay", "playforce", "vplayforce", "cplayforce", "cvplayforce", "lay", "LAY"] ,prefixes=["/", "!", "%", ",", "", ".", "@", "#", "P", "p"])
...
@app.on_callback_query(filters.regex("ERAmousAdmin") & ~BANNED_USERS)
async def ERAmous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
